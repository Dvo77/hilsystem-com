 ...
 *           Guild Media Viewer (popup modal for guild_media assets) + tag-driven
 *           auto-display via HILShell.media.renderForConcept()
 *
    ...
    media: {
      ...
      async renderForConcept(conceptSlug, targetElId, opts = {}) {
        ...
        try {
          ...
          const snap = await getDocs(q);
          if (snap.empty) { container.innerHTML = ''; return; } // nothing tagged yet — render nothing, not an error
