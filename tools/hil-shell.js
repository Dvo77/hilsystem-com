 ...
 *
 * CHANGELOG:
 *   v2.9 — Added Guild to nav (tools/hil-guild.html). Guild was formerly a tab
 *          inside Family Ledger (#tab-guild) — badges/milestones display moved
 *          out to its own tool page; Ledger keeps the badge-award trigger logic
 *          since that's where the underlying behavior (items, donations, trades)
 *          actually happens. See HIL Firestore Schema addendum for
 *          team_members/{memberId}/milestones subcollection.
